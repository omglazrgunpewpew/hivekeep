...
const dict: typeof en = {
  ...
  home: {
    ...
    tourTeaser: {
      kicker: '应用内部',
      heading: '眼见为实。',
      p: '来自一个运行中蜂巢的真实截图:对话、工具调用、保险库、迷你应用等等。',
      cta: '开始导览',
    },
  },
  ...
  tour: {
    meta: {
      title: 'Hivekeep 截图导览',
      description: '通过 30 多张真实截图导览 Hivekeep:智能体对话、工具调用、加密保险库、迷你应用、定时任务等。',
    },
    kicker: '导览',
    heading: '看看蜂巢内部。',
    ...
    groups: {
      ...
      organize: { title: '组织与自动化', sub: '委派任务、定时作业和 webhook:多件事同时推进。' },
